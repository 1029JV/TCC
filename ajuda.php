        ...
        <section class="container mt-3">
            ...
            <form method="post" action="#">
                ...
                <div class="mb-3">
                    ...
                    <textarea rows="10" class="form-control" id="texto" placeholder="Email recebidos com ofensas, acusações sem fundamento e sem qualquer contribuição para nosso crescimento e amadurecimento, serão descartados." required=""></textarea>
                </div>
                </div>
                </div>
                <hr class="mb-4">
